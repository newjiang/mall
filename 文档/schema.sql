CREATE DATABASE IF NOT EXISTS `mall_db` DEFAULT CHARACTER SET utf8 COLLATE utf8_bin;
...
CREATE TABLE `t_activity` (
  `activity_id` BIGINT(18) UNSIGNED NOT NULL COMMENT '活动ID',
  ...
  `creator_id` BIGINT(18) UNSIGNED DEFAULT NULL COMMENT '创建人ID',
  `created_time` TIMESTAMP NULL DEFAULT NULL COMMENT '创建时间',
  `editor` VARCHAR(255) COLLATE utf8_bin DEFAULT NULL COMMENT '最后修改人',
  `editor_id` BIGINT(18) UNSIGNED DEFAULT NULL COMMENT '最后修改人ID',
  `edited_time` TIMESTAMP NULL DEFAULT NULL COMMENT '最后修改时间',
...
CREATE TABLE `t_address` (
  `address_id` BIGINT(18) UNSIGNED NOT NULL COMMENT '地址ID',
...
CREATE TABLE `t_attribute` (
  `attribute_id` BIGINT(18) UNSIGNED NOT NULL COMMENT '属性ID',
  `sort_id` BIGINT(18) UNSIGNED DEFAULT NULL COMMENT '分类ID',
...
CREATE TABLE `t_attribute_item` (
  `attribute_item_id` BIGINT(18) UNSIGNED NOT NULL COMMENT '属性选项ID',
  `attribute_id` BIGINT(18) UNSIGNED DEFAULT NULL COMMENT '属性ID',
...
CREATE TABLE `t_attribute_item_spu` (
  `attr_sku_id` BIGINT(18) UNSIGNED NOT NULL,
  `spu_id` BIGINT(18) UNSIGNED DEFAULT NULL,
...
CREATE TABLE `t_auth` (
  `auth_id` BIGINT(18) UNSIGNED NOT NULL COMMENT '权限ID',
...
CREATE TABLE `t_brand` (
  `brand_id` BIGINT(18) UNSIGNED NOT NULL COMMENT '品牌ID',
...
CREATE TABLE `t_cart` (
  `cart_id` BIGINT(18) UNSIGNED NOT NULL COMMENT '购物车ID',
  `user_id` BIGINT(18) UNSIGNED DEFAULT NULL COMMENT '用户ID',
  `sku_id` BIGINT(18) UNSIGNED DEFAULT NULL COMMENT 'SKU_ID',
  `create_time` TIMESTAMP NULL DEFAULT NULL COMMENT '创建时间',
...
CREATE TABLE `t_collection` (
  `collection_id` BIGINT(18) UNSIGNED NOT NULL COMMENT '收藏ID',
  `user_id` BIGINT(18) UNSIGNED DEFAULT NULL COMMENT '用户',
  `sku_id` BIGINT(18) UNSIGNED DEFAULT NULL COMMENT 'SKU_ID',
  `shop_id` BIGINT(18) UNSIGNED DEFAULT NULL COMMENT '店铺',
  `create_time` TIMESTAMP NULL DEFAULT NULL COMMENT '创建时间',
  `creator` VARCHAR(255) COLLATE utf8_bin DEFAULT NULL COMMENT '创建人',
  `creator_id` BIGINT(18) UNSIGNED DEFAULT NULL COMMENT '创建人ID',
  `created_time` TIMESTAMP NULL DEFAULT NULL COMMENT '创建时间',
...
CREATE TABLE `t_coupon` (
  `coupon_id` BIGINT(18) UNSIGNED NOT NULL COMMENT '优惠',
  `shop_id` BIGINT(18) UNSIGNED DEFAULT NULL COMMENT '店铺ID',
  `activity_id` BIGINT(18) UNSIGNED DEFAULT NULL COMMENT '活动',
...
CREATE TABLE `t_evaluation` (
  `eval_id` BIGINT(18) UNSIGNED NOT NULL COMMENT '评价',
  `order_item_id` BIGINT(18) UNSIGNED DEFAULT NULL COMMENT '订单ID',
...
CREATE TABLE `t_footprint` (
  `footprint_id` BIGINT(18) UNSIGNED NOT NULL COMMENT '足迹ID',
  `user_id` BIGINT(18) UNSIGNED DEFAULT NULL COMMENT '用户ID',
  `sku_id` BIGINT(18) UNSIGNED DEFAULT NULL COMMENT 'SKU_ID',
  `create_time` TIMESTAMP NULL DEFAULT NULL COMMENT '创建时间',
  `creator` VARCHAR(255) COLLATE utf8_bin DEFAULT NULL COMMENT '创建人',
...
CREATE TABLE `t_logistics` (
  `logistics_id` BIGINT(18) UNSIGNED NOT NULL COMMENT '物流',
  `order_item_id` BIGINT(18) UNSIGNED DEFAULT NULL COMMENT '订单项ID',
  `logistics_status_id` BIGINT(18) UNSIGNED DEFAULT NULL COMMENT '物流状态ID',
...
CREATE TABLE `t_logistics_status` (
  `logistics_status_id` BIGINT(18) UNSIGNED NOT NULL COMMENT '物流状态ID',
...
CREATE TABLE `t_merchant` (
  `merchant_id` BIGINT(18) UNSIGNED NOT NULL COMMENT '商家ID',
...
CREATE TABLE `t_order` (
  `order_id` BIGINT(18) UNSIGNED NOT NULL COMMENT '订单',
  `user_id` BIGINT(18) UNSIGNED DEFAULT NULL COMMENT '用户ID',
  `order_status_id` BIGINT(18) UNSIGNED DEFAULT NULL COMMENT '订单状态',
  `create_time` TIMESTAMP NULL DEFAULT NULL COMMENT '创建时间',
...
CREATE TABLE `t_order_item` (
  `order_item_id` BIGINT(18) UNSIGNED NOT NULL COMMENT '订单项ID',
  `order_id` BIGINT(18) UNSIGNED DEFAULT NULL COMMENT '订单',
  `sku_id` BIGINT(18) UNSIGNED DEFAULT NULL COMMENT 'SKU_ID',
  `address_id` BIGINT(18) UNSIGNED DEFAULT NULL COMMENT '地址',
...
CREATE TABLE `t_order_status` (
  `order_status_id` BIGINT(18) UNSIGNED NOT NULL COMMENT '订单状态ID',
...
CREATE TABLE `t_payment` (
  `pay_id` BIGINT(18) UNSIGNED NOT NULL COMMENT '支付ID',
  `order_id` BIGINT(18) UNSIGNED DEFAULT NULL COMMENT '订单ID',
  `user_id` BIGINT(18) UNSIGNED DEFAULT NULL COMMENT '用户',
  `payment_status_id` BIGINT(18) UNSIGNED DEFAULT NULL COMMENT '支付状态ID',
  `create_time` TIMESTAMP NULL DEFAULT NULL COMMENT '创建时间',
  `completed_time` TIMESTAMP NULL DEFAULT NULL COMMENT '完成时间',
...
CREATE TABLE `t_role_auth` (
  `role_auth_id` BIGINT(18) UNSIGNED NOT NULL COMMENT '角色权限ID',
  `auth_id` BIGINT(18) UNSIGNED DEFAULT NULL COMMENT '权限ID',
...
CREATE TABLE `t_shop` (
  `shop_id` BIGINT(18) UNSIGNED NOT NULL COMMENT '店铺ID',
  `merchant_id` BIGINT(18) UNSIGNED DEFAULT NULL COMMENT '商家ID',
...
CREATE TABLE `t_shop_activity` (
  `shop_activity_id` BIGINT(18) UNSIGNED NOT NULL COMMENT '商家活动ID',
  `shop_id` BIGINT(18) UNSIGNED DEFAULT NULL COMMENT '商家ID',
...
CREATE TABLE `t_shop_sku` (
  `shop_sku_id` BIGINT(18) UNSIGNED NOT NULL COMMENT '店铺SKU_ID',
  `sku_id` BIGINT(18) UNSIGNED DEFAULT NULL COMMENT 'SKU_ID',
  `shop_id` BIGINT(18) UNSIGNED DEFAULT NULL COMMENT '店铺ID',
  `creator` VARCHAR(255) COLLATE utf8_bin DEFAULT NULL COMMENT '创建人',
  `creator_id` BIGINT(18) UNSIGNED DEFAULT NULL COMMENT '创建人ID',
...
CREATE TABLE `t_sku` (
  `sku_id` BIGINT(18) UNSIGNED NOT NULL COMMENT 'SKU_ID',
  `spu_id` BIGINT(18) UNSIGNED DEFAULT NULL COMMENT 'SPU_ID',
...
CREATE TABLE `t_sort` (
  `sort_id` BIGINT(18) UNSIGNED NOT NULL COMMENT '分类ID',
  `parent_id` BIGINT(18) UNSIGNED DEFAULT NULL COMMENT '父ID',
...
CREATE TABLE `t_spec_group` (
  `spec_group_id` BIGINT(18) UNSIGNED NOT NULL COMMENT '规格组ID',
...
CREATE TABLE `t_spec_item` (
  `spec_item_id` BIGINT(18) UNSIGNED NOT NULL COMMENT '规格选项ID',
  `spec_id` BIGINT(18) UNSIGNED DEFAULT NULL COMMENT '规格ID',
...
CREATE TABLE `t_spec_item_sku` (
  `spec_item_sku_id` BIGINT(18) UNSIGNED NOT NULL,
  `spec_item_id` BIGINT(18) UNSIGNED DEFAULT NULL,
...
CREATE TABLE `t_specification` (
  `spec_id` BIGINT(18) UNSIGNED NOT NULL COMMENT '规格ID',
  `sort_id` BIGINT(18) UNSIGNED DEFAULT NULL COMMENT '分类ID',
  `spec_group_id` BIGINT(18) UNSIGNED DEFAULT NULL COMMENT '规格组',
...
CREATE TABLE `t_spu` (
  `spu_id` BIGINT(18) UNSIGNED NOT NULL COMMENT 'SPU_ID',
  `sort_id` BIGINT(18) UNSIGNED DEFAULT NULL COMMENT '分类ID',
...
CREATE TABLE `t_user_activity` (
  `user_activity_id` BIGINT(18) UNSIGNED NOT NULL COMMENT '用户活动ID',
  `user_id` BIGINT(18) UNSIGNED DEFAULT NULL COMMENT '用户',
  `activity_id` BIGINT(18) UNSIGNED DEFAULT NULL COMMENT '活动ID',
  `creator` VARCHAR(255) COLLATE utf8_bin DEFAULT NULL COMMENT '创建人',
  `creator_id` BIGINT(18) UNSIGNED DEFAULT NULL COMMENT '创建人ID',
...
CREATE TABLE `t_user_auth` (
  `user_auth_id` BIGINT(18) UNSIGNED NOT NULL COMMENT '用户权限ID',
  `user_id` BIGINT(18) UNSIGNED DEFAULT NULL COMMENT '用户ID',
...
CREATE TABLE `t_user_coupon` (
  `user_coupon_id` BIGINT(18) UNSIGNED NOT NULL COMMENT '用户优惠ID',
  `user_id` BIGINT(18) UNSIGNED DEFAULT NULL COMMENT '用户ID',
...
CREATE TABLE `t_user_info` (
  `user_info_id` BIGINT(18) UNSIGNED NOT NULL COMMENT '用户信息ID',
  `user_id` BIGINT(18) UNSIGNED DEFAULT NULL COMMENT '用户ID',
...
CREATE TABLE `t_user_role` (
  `user_role_id` BIGINT(18) UNSIGNED NOT NULL COMMENT '用户角色ID',
  `user_id` BIGINT(18) UNSIGNED DEFAULT NULL COMMENT '用户ID',
...
CREATE TABLE `t_select` (
  ...
  `item` VARCHAR(100) COLLATE utf8_bin DEFAULT NULL COMMENT '选项',
  `parent_id` BIGINT(20) DEFAULT NULL COMMENT '父ID',
  `status` varchar(50) COLLATE utf8_bin DEFAULT NULL COMMENT '状态',
  `number` INT(11) DEFAULT NULL COMMENT '序号',
  `valid` INT(11) DEFAULT NULL COMMENT '是否有效 1:有效,0:无效(删除)',
  `creator` VARCHAR(255) COLLATE utf8_bin DEFAULT NULL COMMENT '创建人',
  `creator_id` BIGINT(18) UNSIGNED DEFAULT NULL COMMENT '创建人ID',
  `created_time` TIMESTAMP NULL DEFAULT NULL COMMENT '创建时间',
  `editor` VARCHAR(255) COLLATE utf8_bin DEFAULT NULL COMMENT '最后修改人',
